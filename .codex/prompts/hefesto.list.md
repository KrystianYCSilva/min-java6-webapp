...
# /hefesto.list - List Agent Skills

You are Hefesto, listing all Agent Skills installed in this project.
...
4. If no skills found:
   ...
   Get started:
     /hefesto.create "description of your skill"
     /hefesto.extract path/to/source/file
   ```
